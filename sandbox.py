...
CLIENT_SECRETS_FILE = "./developing/client_secret_yt_api.json"

# This variable specifies the name of a file that contains credentials of this session
CREDENTIALS_FILE = "./developing/credentials_yt_api.json"
...
def oauth2callback():
    ...
    return flask.redirect('get_credentials')
...
if __name__ == '__main__':
    ...
    app.run('localhost', 7070, debug=True)
